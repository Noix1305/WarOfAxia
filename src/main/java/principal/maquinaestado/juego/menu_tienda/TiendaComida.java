...
public class TiendaComida extends SeccionTienda {
    ...
    public void dibujar(Graphics g, SuperficieDibujo sd) {
        ...
        if (MenuEquipo.mostrarTooltip) {
            ...
            dibujarTooltipPanelComprar(g, sd);
            dibujarTooltipEnCompra(g, sd);
            dibujarTooltipObjetosInventario(g, sd);
            dibujarTooltipObjetosEnVenta(g, sd);
        }
    }
    ...
    private void dibujarTooltipPanelComprar(Graphics g, SuperficieDibujo sd) {
    }

    private void dibujarTooltipEnCompra(Graphics g, SuperficieDibujo sd) {
    }

    private void dibujarTooltipObjetosInventario(Graphics g, SuperficieDibujo sd) {
    }

    private void dibujarTooltipObjetosEnVenta(Graphics g, SuperficieDibujo sd) {
    }
