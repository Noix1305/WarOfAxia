...
public class RegistroTiendas {
    ...
    public static ArrayList<String> obtenerTienda(int idTienda) {
        ...
        listaIdsObjetos = switch (idTienda) {
            case 1 -> new ArrayList<>(List.of("500", "502", "503", "504", "505",
                    "400", "401", "402", "600", "601", "616", "617",
                    "632", "648", "1", "2", "3", "4", "700", "701", "716", "732", "733", "734"));
            case 2 -> new ArrayList<>(List.of("600", "601", "616", "617", "632", "648"));
            default -> listaIdsObjetos;
        };
